...
class KeyboardViewController: UIInputViewController {
    ...
    override func viewDidLoad() {
        ...
        hodorButton.frame = CGRect(x: 50, y: 50, width: 50, height: 50)
        hodorButton.setBackgroundImage(UIImage(named: "hodor.jpg"), for: UIControl.State.normal)
        hodorButton.addTarget(self, action: #selector(honorTapped), for: UIControl.Event.touchUpInside)
